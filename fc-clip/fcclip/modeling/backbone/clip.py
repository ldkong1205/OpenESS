...
class CLIP(Backbone):
    def __init__(self, cfg, input_shape):
        ...
        # self.clip_model.attn_mask = self.clip_model.build_attention_mask(context_length).to("cuda" if torch.cuda.is_available() else "cpu")
    ...
    def tokenize_text(self, text):
        ...
        # return self.text_tokenizer(text, context_length=self.clip_model.context_length)
