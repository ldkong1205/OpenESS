...
class VisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.IMAGE, parallel=False):
        ...
        lvis_classes = open("./fc-clip/fcclip/data/datasets/lvis_1203_with_prompt_eng.txt", 'r').read().splitlines()
        ...
        user_classes = [
            "road", "street", 
            "sky", "building",
            "pole", "traffic sign pole", "light pole", "traffic light box",
            "traffic-sign", "parking-sign", "direction-sign",
            "vegetation", "tree", "tree trunk",  "woods", 
            "grass",
            "person", "pedestrian", "walking people", "standing people", "sitting people", 
            "car", "jeep", "SUV", "van", "caravan", "truck",  
            "trailer", "bus",  "train",  "tram",
