...
import torch
from DSEC.dataset.sequence_ov import Sequence
    ...
    def __init__(
        ...
        if mode == 'train':
            ...
            for child in train_path.iterdir():
                if any(k in str(child) for k in train_sequences_namelist):
                    train_sequences.append(Sequence(
                        ...
                        nr_events_data, delta_t_per_data,
                        nr_events_window,
                        nr_bins_per_data, require_paired_data,
                        normalize_event,
                        separate_pol, semseg_num_classes,
                        augmentation, fixed_duration,
                        resize=resize,
            ...
            val_sequences_namelist = [
                'zurich_city_13_a', 'zurich_city_14_c', 'zurich_city_15_a',
            ]
