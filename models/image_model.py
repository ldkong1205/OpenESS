...
from models.modules.resnet_encoder import resnet_encoders
import models.modules.dino.vision_transformer as dino_vit
# import clip
...
class DilationFeatureExtractor(nn.Module):
    ...
    def __init__(self, image_weights, preprocessing=None):
        ...
        if weights is not None:
            ...
            print("Loaded '{}' weights for the teacher network~".format(image_weights))
        ...
        self.decoder = nn.Sequential(
            nn.Conv2d(in1, model_n_out, 1),
            nn.Upsample(scale_factor=4, mode="bilinear", align_corners=True),
        )
        self.preprocessing = preprocessing
        self.normalize_feature = normalize_features
